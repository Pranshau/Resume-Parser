...
if __name__ == "__main__":
    ...
    # Candidate resumes with modified names
    candidate_resumes = {
        "John Smith": "Full-stack developer experienced in Python, Django, JavaScript, and React.",
        "Jane Johnson": "Java developer with expertise in Spring Boot and Hibernate.",
        "Bob White": "Front-end developer skilled in HTML, CSS, and JavaScript.",
        "Alice Green": "Python developer with a focus on data analysis and machine learning.",
        "Michael Brown": "Backend developer experienced in Java and Spring Framework.",
        "Sophia Wilson": "Software engineer with experience in C++ and Linux system programming.",
        "Oliver Taylor": "Web developer proficient in PHP, Laravel, and MySQL.",
        "Emma Clark": "Mobile app developer with expertise in Android and Kotlin.",
        "William Rodriguez": "Game developer skilled in Unity and C#.",
        "Ava Martinez": "Embedded systems developer experienced in C and RTOS.",
        ...
        "Olivia Perez": "Software architect with extensive experience in system design and scalability.",
